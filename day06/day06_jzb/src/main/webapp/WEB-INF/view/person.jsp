				...
				<div class="input-group">
					...
					<select class="form-control" name="expressTypeId" id = "txt_search_roleid">
						...
						<c:forEach items="${comList }" var="c">
						 	<option value="${c.expressTypeId }">${c.expressName1 }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>特点：</td>
								<td>
									<input type="checkbox" id="expressTrait" name="expressTrait" value="耐心" aria-required="true" required/>耐心
									<input type="checkbox" id="expressTrait" name="expressTrait" value="热情" aria-required="true" required/>热情
									<input type="checkbox" id="expressTrait" name="expressTrait" value="干练" aria-required="true" required/>干练
									<input type="checkbox" id="expressTrait" name="expressTrait" value="效率" aria-required="true" required/>效率
								</td>
							</tr>
							<tr>
								<td>入职时间：</td>
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_edit").click(function(){
	    		...
	    		if(getSelections && getSelections.length==1){
	    			$("input:checkbox[name='expressTrait']").prop("checked", false);
