...
<body class="gray-bg">
				...
				<div class="form-group col-lg-7">
					...
					<div class="col-sm-8">
						<input placeholder="开始时间" id="txt_search_start" name="start"
							...
							placeholder="结束时间" id="txt_search_end" name="end"
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table
							...
							<tr>
								<td>学生爱好：</td>
								<td><input type="checkbox" name="sHobby" id="sHobby1"
									value="篮球">篮球 <input type="checkbox" name="sHobby"
									id="sHobby2" value="足球">足球 <input type="checkbox"
									name="sHobby" id="sHobby3" value="排球">排球</td>
								<td>学生生日：</td>
	...
	<!-- 新增对话框 -->
	<div class="modal fade" id="modal_user_insert" role="dialog"
		aria-labelledby="modal_user_insert" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_tb" method="post" action="getTbMajor.htm">
						<input type="hidden" name="mdId" id="hidden_txt_mdid" value="" />
						<table
							style="border-collapse: separate; border-spacing: 0px 10px;">
							<tr>
								<td>专业名称：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"
								id="submit_form_tb_btn">保存</button>
							<button type="button" class="btn btn-default"
								data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<!-- 导入对话框 -->
	<div class="modal fade" id="modal_user_imp" role="dialog"
		aria-labelledby="modal_user_imp" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_imp" method="post" action="impStu.htm"
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"
								id="submit_form_imp_btn">保存</button>
							<button type="button" class="btn btn-default"
								data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<div class="modal fade" id="zhu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="zhushow" style="width:400px;height:400px">
	...
	<!--导出对话框 -->
	<div class="modal fade" id="modal_user_exp" role="dialog"
		aria-labelledby="modal_user_exp" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
				...
				<div class="modal-body">导出所有数据</div>
				<div class="modal-footer">
	...
	<script type="text/javascript">
		...
		var validator = $("#form_tb").validate({
			submitHandler : function(form) {
				$(form).ajaxSubmit({
					dataType : "json",
					success : function(data) {
		...
		$("#submit_form_tb_btn").click(function() {
			$("#form_tb").submit();
		});
		...
		var ButtonInit = function() {
			...
			oInit.Init = function() {
				...
				$("#btn_add")
						.click(
								function() {
									...
									$("#form_user").resetForm();
									document
											.getElementById("hidden_txt_userid").value = '';
				...
				$("#btn_addtb").click(function() {
					$("#form_user").resetForm();
					document.getElementById("hidden_txt_mdid").value = '';
					$('#modal_user_insert').modal({
						backdrop : 'static',
						keyboard : false
					});
		...
		function initEditUser(getSelection) {
			...
			$('#sHobby1').prop("checked",
					getSelection.sHobby.indexOf("篮球") != -1);
			$('#sHobby2').prop("checked",
					getSelection.sHobby.indexOf("足球") != -1);
			$('#sHobby3').prop("checked",
					getSelection.sHobby.indexOf("排球") != -1);
			$('#sBirth')
					.val(new Date(getSelection.sBirth).Format("yyyy-MM-dd"));
