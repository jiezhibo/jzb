...
<body class="gray-bg">
        	 ...
        	 <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="pname" class="form-control" id="txt_search_ename" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">所属公司</span>
					<select class="form-control" name="companyid" id = "txt_search_companyid" aria-required="true" required>
					<option value="">---请选择---</option>
						<c:forEach items="${pcompanyList }" var="d">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_emp" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>入职时间：</td>
								<td><input type="date" id="datime" name="datime"
									class="form-control" aria-required="true" required/></td>
							</tr>
						</table>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 ...
					 <h4 class="modal-title" id="modal_user_del_head"> 删除  </h4>
				</div>
				<div class="modal-body">
							删除所选记录？
				</div>
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="del_user_btn">删除</button>
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            }, 
	            {
	                ...
	                formatter:function(value,row,index){
	                	return row.pcompany.companyname;
	                }
	            },{
	                field: 'datime',
	                title: '入职时间',
	...
	function initEditUser(getSelection){
		...
		$('#datime').val(new Date(getSelection.datime).Format('yyyy-MM-dd'));
