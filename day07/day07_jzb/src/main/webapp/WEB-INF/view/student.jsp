...
<body class="gray-bg">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>
									...
									<img src="" width="100px" height="100px" id="picture">
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>入学日期：</td>
								<td><input type="date" id="joinschooltime" name="joinschooltime"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>班主任：</td>
	...
	function initEditUser(getSelection){
		...
		$("#picture").prop("src","/photo/"+getSelection.img);
		$('#sname').val(getSelection.sname);
		$("input[value='"+getSelection.sex+"']").prop("checked",true);
		$('#joinschooltime').val(new Date(getSelection.joinschooltime).Format("yyyy-MM-dd"));
